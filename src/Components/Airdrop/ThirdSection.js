				...
				<div className={css(styles.display)}>
					<div className={css(styles.button_group)}>
						<ButtonGroup>
							...
							>
								<img src={process.env.PUBLIC_URL+"assets/Airdrop/twitter.png"} width={30} alt="fifth" />
								<span
					...
					<img src={process.env.PUBLIC_URL+"assets/Airdrop/ccc.png"} className={css(styles.image)} alt="sixth" />
				</div>
			</section>
			{/* <RainParticle/> */}
			<section className={css(styles.section_each)}>
